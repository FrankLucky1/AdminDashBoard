...
function App() {
  const {activeMenu, themeSettings, currentColor, setThemeSettings}= useStateContext();
  const active= true;
      ...
      <BrowserRouter>
       <div className='flex relative dark:bg-main-dark-bg overflow-hidden'>
          ...
          {activeMenu ? (
            ...
            <div className='w-0 sidebar dark:bg-secondary-dark-bg'>
              <Sidebar/>
            </div>
          )}

          <div className={`dark:bg-main-dark-bg w-full min-h-screen bg-main-bg ${activeMenu ? 'md:ml-72': 'flex-2'}` }>
